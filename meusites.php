    ...
    <main>
        <section>
            <div class="sair wow animate__animated animate__fadeInLeft">
                <a href="index.html"><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
            ...
            <div class="site contaiter">
                ...
                <div class="texto">
                    <h1>Não Postado</h1>
                    <p>
                        Formulario desenvolvido por Gustavo para aprendizado com javaScript e SQL.
                    </p>
                    <div class="site minhasHB">
                        <div class="linguagemHB">
                            <div>
