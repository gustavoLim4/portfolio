...
<body>
    <main>
        ...
        <div class="buttMeuSite">
            <button class="wow  animate__animated animate__slideInLeft"><strong><a href="meusites.php">Meus sites</a></strong></button>
            <button class=" wow  animate__animated animate__slideInRight"><strong><a href="sobremim.php">Sobre mim</a></strong></button>
        </div>
        <div class="site minhasHB">
            <h1>Minhas habilidades:</h1>
            <div class="linguagem">
                <div class="html wow animate__animated animate__slideInLeft">
                ...
                <div class="css wow wow animate__animated animate__slideInLeft">
                ...
                <div class="js wow animate__animated  animate__slideInUp">
                ...
                <div class="php wow animate__animated  animate__slideInUp">
                ...
                <div class="sql wow animate__animated animate__slideInRight">
                ...
                <div class="jquery wow animate__animated animate__slideInRight">
