...
<body>
    <main>
        <div class="fotodoResposivo">
            <div class="Bem-vindo">
                <img src="./img/Bem-vindo.png" alt="">
                <img src="./img/Bem-vindo2.png" alt="">

            </div>
            <div class="minhafoto  wow  animate__animated animate__zoomIn">
        ...
        <div class="minha-habilidade wow  animate__animated  animate__slideInUp">
            ...
            <div class="linguagem ">
                ...
                <div class=" wow wow animate__animated animate__slideInLeft">
            ...
            <div class="buttMeuSite">
                <button class="wow  animate__animated  animate__slideInUp"><a href="meusites.php">Meus sites</a></button>
            </div>
        </div>
    </main>
    ...
    <footer>
        <div class="rodape ">
            <div class=" imglog wow  animate__animated  animate__slideInUp">
                <img src="./img/codetech.png" alt="">
            </div>
            <div class="informacoes  wow  animate__animated  animate__slideInUp">
                <div>
                    <a href=" https://w.app/QtiwaY"> <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                ...
                <div>
                    <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="currentColor" class="bi bi-telephone-forward" viewBox="0 0 16 16">
                ...
                <div>
                    ...
                    <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <div class="maps  wow  animate__animated  animate__slideInUp">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3659.2351201819047!2d-46.47257548924125!3d-23.488039278762013!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce61a8e5995059%3A0x82cd3660ce861bcb!2sRua%20Ricardo%20Butarello%2C%20765%20-%20Jardim%20Matarazzo%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2003813-010!5e0!3m2!1spt-BR!2sbr!4v1706042933816!5m2!1spt-BR!2sbr" width="400" height="240" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
        <div class="foote1  wow  animate__animated  animate__slideInUp">
            <h4>© Portifólio curricular</h4>
        </div>
